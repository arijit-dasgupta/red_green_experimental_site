...
DATASET_NAME = 'redgreen_experiment_2'  # Specific dataset folder name within PATH_TO_DATA_FOLDER
...
EXPERIMENT_RUN_VERSION = 'before_final_v0'  # Version identifier for this experiment run
